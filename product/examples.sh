...
#python analysis.py  data/new_section_1.tif data/slums_approved.shp features/new_section_1__BD1-2-3_BK20_SC50_TRhog.vrt --block_size 20
python analysis.py  data/new_section_1.tif data/slums_approved.shp features/new_section_1__BD1-2-3_BK20_SC50_TRlsr.vrt --block_size 20
