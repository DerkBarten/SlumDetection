...
\begin{figure}
	\centering
	\begin{tabular}{ccc}
		\subfloat{\includegraphics[width=5cm]{images/RID/1}}&
		\subfloat{\includegraphics[width=5cm]{images/RID/2}}&
		\subfloat{\includegraphics[width=5cm]{images/RID/3}}\\
		\subfloat{\includegraphics[width=5cm]{images/RID/4}}&
		\subfloat{\includegraphics[width=5cm]{images/RID/5}}&
		\subfloat{\includegraphics[width=5cm]{images/RID/6}}\\
	\end{tabular}
