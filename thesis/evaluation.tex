...
Figure \ref{hog_inc_bk} shows the effect of an increased block size on
...
the size of a block should have little to no influence on the predictive value of the
feature.
