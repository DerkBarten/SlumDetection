...
\begin{tabular}{cc}
  ...
  \subfloat{\includegraphics[width=4cm]{images/HoG/inc_sc/section_1_boxplot_hog_BK20_SC150_F2}}\\
  \subfloat{\includegraphics[width=4cm]{images/HoG/inc_sc/section_1_kde_hog_BK20_SC50_F2}}&
  \subfloat{\includegraphics[width=4cm]{images/HoG/inc_sc/section_1_kde_hog_BK20_SC150_F2}}\\
\end{tabular}
...
\begin{figure}
\begin{tabular}{cc}
  \subfloat{\includegraphics[width=4cm]{images/LSR/inc_sc/s1/section_1_boxplot_lsr_BK20_SC50_F1}}&
  \subfloat{\includegraphics[width=4cm]{images/LSR/inc_sc/s1/section_1_boxplot_lsr_BK20_SC150_F1}}\\
  \subfloat{\includegraphics[width=4cm]{images/LSR/inc_sc/s1/section_1_kde_lsr_BK20_SC50_F1}}&
  \subfloat{\includegraphics[width=4cm]{images/LSR/inc_sc/s1/section_1_kde_lsr_BK20_SC150_F1}}
\end{tabular}
