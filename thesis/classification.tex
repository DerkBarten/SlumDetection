...
% TODO: balanced dataset here instead of oversampling
...
%
%Similarly to the scales parameter, we will conduct a separate experiment to discover the effects of different data balancing methods.
